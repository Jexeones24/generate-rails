...
Movement.create(name: "Knees-to-elbow", description: "Gymnastics", skill: "Low", seconds_per: 3)
Movement.create(name: "Toe-to-bar", description: "Gymnastics", skill: "Low", seconds_per: 4)
...
Movement.create(name: "Run", description: "Cardio", skill: "Low", seconds_per: "400m")
Movement.create(name: "Row", description: "Cardio", skill: "Moderate", seconds_per: "500m")
Movement.create(name: "Double-Under", description: "Cardio", skill: "Low", seconds_per: 1)
Movement.create(name: "Plank Hold", description: "Gymnastics", skill: "Moderate", seconds_per: 1)
Movement.create(name: "Broad Jump", description: "Parkour", skill: "Moderate", seconds_per: 5)
Movement.create(name: "Bear Crawl", description: "Parkour", skill: "High", seconds_per: 20)
Movement.create(name: "Wall Walk", description: "Parkour", skill: "High", seconds_per: 15)
